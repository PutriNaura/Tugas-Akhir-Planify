...
<body>
    ...
    <!-- Start Main Content -->
        ...
        <!-- Start Modal List DONE-->
            <div id="modal" class="modal-list">
                <div class="modal-content">
                    <form class="addlistform" action="upcoming_proseslist.php" METHOD="POST">
        ...
        <!-- Start Modal Add New Task DONE-->
        <div id="addNewModal" class="modal-newtask">
            <div class="modal-content2">
                ...
                <form class="formaddtask" action="upcoming_prosestask.php" METHOD="POST">
                    <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <input type="date" id="datetoday" name="datetask" class="form-control">
                    </div>
                    <div class="row">
        ...
        <!-- Start Content -->
            <div class="content">
                ...
                <!-- Start Card Today DONE-->
                    <div class="card-up">
                        <div class="cardup-tittle">Today</div>
                        <table class="custom-table">
                            ...
                            <?php 
                                ...
                                $upcoming_td = "SELECT t.id_task, t.user_id, t.input_task, t.des_task, l.color_code, l.name_list, t.tgl, t.rep_option, t.sub_1, t.sub_2, t.sub_3, t.status_task
                                FROM dt_task t
                                INNER JOIN list_task l ON t.list_id = l.id_list
                                WHERE t.user_id = $user_id AND DATE(t.tgl) = CURDATE()";
                                $result =mysqli_query($connection, $upcoming_td);
                ...
                <!-- End Card Today -->
                <div class="row-up">
                <!-- Start Card Tommorow DONE-->
                    <div class="card-up2">
                        <div class="cardup-tittle">Tommorow</div>
                        <table class="custom-table">
                            <tbody>
                                <?php 
                                //ambil data
                                ...
                                $upcoming_ys = "SELECT t.id_task, t.user_id, t.input_task, t.des_task, l.color_code, l.name_list, t.tgl, t.rep_option, t.sub_1, t.sub_2, t.sub_3, t.status_task
                                FROM dt_task t
                                INNER JOIN list_task l ON t.list_id = l.id_list
                                WHERE t.user_id = $user_id AND DATE(t.tgl) = DATE_ADD(CURDATE(), INTERVAL 1 DAY)";
                                $result =mysqli_query($connection, $upcoming_ys);
                                ...
                                echo "<tr><td>No tasks for yesterday.</td></tr>";
                                }
                                ?> 
                            </tbody>
                        </table>
                ...
                <!-- End Card Tommorow -->
                <!-- Start Card This Week DONE-->
                <div class="card-up3">
                    <div class="cardup-tittle">This Week</div>
                    <table class="custom-table">
                        <tbody>
                            <?php 
                            //ambil data
                            ...
                            $upcoming_tw = "SELECT t.id_task, t.user_id, t.input_task, t.des_task, l.color_code, l.name_list, t.tgl, t.rep_option, t.sub_1, t.sub_2, t.sub_3, t.status_task
                            FROM dt_task t
                            INNER JOIN list_task l ON t.list_id = l.id_list
                            WHERE t.user_id = $user_id 
                            AND DATE(t.tgl) BETWEEN DATE_SUB(CURDATE(), INTERVAL (DAYOFWEEK(CURDATE()) - 1) DAY) AND DATE_ADD(CURDATE(), INTERVAL (7 - DAYOFWEEK(CURDATE())) DAY)";
                            $result =mysqli_query($connection, $upcoming_tw);
